function demoBurglarSimple2()
    ...
    PotBurglar=PotArray(burglar,[1//100 99//100])
    PotEarthquake=PotArray(earthquake,[1//1000000 (1-1//1000000)])
    ...
    table=zeros(2,2,2)
    table[yes,yes,yes]=9999//10000
    table[yes,yes,no]=99//100
    table[yes,no,yes]=99//100
    table[yes,no,no]=1//10000
